...
export type GetBoardsQuery = {
	__typename?: "Query";
	getBoards: Array<{ __typename?: "Board"; name: string; description: string }>;
};
...
export type GetUsersQuery = {
	__typename?: "Query";
	getUsers: Array<{ __typename?: "User"; username: string; email: string }>;
};
...
export const GetBoardsDocument = `
  ...
  getBoards(input: $input) {
    ...
    `;
export const useGetBoardsQuery = <TData = GetBoardsQuery, TError = unknown>(
	...
	useQuery<GetBoardsQuery, TError, TData>(
		["getBoards", variables],
		fetcher<GetBoardsQuery, GetBoardsQueryVariables>(
			dataSource.endpoint,
...
export const LoginAdminDocument = `
  ...
  loginAdmin(input: $input)
    ...
    `;
export const useLoginAdminMutation = <TError = unknown, TContext = unknown>(
	dataSource: { endpoint: string; fetchParams?: RequestInit },
	options?: UseMutationOptions<
		LoginAdminMutation,
		TError,
	...
	>(
		["loginAdmin"],
		(variables?: LoginAdminMutationVariables) =>
			fetcher<LoginAdminMutation, LoginAdminMutationVariables>(
				dataSource.endpoint,
				dataSource.fetchParams || {},
				LoginAdminDocument,
				variables
